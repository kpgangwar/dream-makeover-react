    ...
    <>
      <div className="contact-page">
        ...
        <div className="contact-content">
          ...
          <div className="contact-buttons">
            <a
              href="https://wa.me/918909087801?text=Hello%20Dream%20Makeover!%20I%20want%20to%20book%20a%20beauty%20service."
              target="_blank"
              rel="noopener noreferrer"
              className="whatsapp-btn"
            >
        ...
        <div className="side-card follow-us">
          ...
          <p>Instagram, Facebook, LinkedIn & YouTube for latest updates 📸</p>
          <div className="social-icons">
            <a href="https://www.instagram.com/krishna6944pal/" target="_blank" rel="noopener noreferrer">
              <img src="/images/instagram.png" alt="Instagram" />
            </a>
